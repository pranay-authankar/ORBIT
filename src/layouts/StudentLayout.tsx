...
import { LayoutDashboard, Users, Instagram, Globe, User, Sparkles, Home } from 'lucide-react';
                ...
                <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-1">
                    ...
                    <div className="pt-4 mt-4 border-t border-gray-100">
                        <NavLink
                            ...
                            `}
                        >
                            <Sparkles className="mr-3 h-5 w-5 text-indigo-500" />
                            AI Doubt Solver
                        </NavLink>
                    </div>
                </nav>
                ...
                <div className="border-t border-gray-200 p-4 bg-gray-50">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-gray-900 truncate">{STUDENT_INFO.name}</p>
                            <p className="text-xs text-gray-500 truncate">{STUDENT_INFO.class}</p>
                        </div>
                    </div>
                </div>
            </aside>
